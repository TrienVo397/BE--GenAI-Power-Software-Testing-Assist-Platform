...
|----------|-------------|-------------|----------|------|--------------|
| REQ-001 | Browser Compatibility | The application must run in the latest version of Chrome or Firefox browser on Windows, Linux and Mac. | Technical | Medium | None |
